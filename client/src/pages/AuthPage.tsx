...
export default function AuthPage() {
  ...
  async function handleGoogleSignIn() {
    ...
    try {
      ...
      if (!existing.data) await createProfile({ id: user.uid, role, full_name: user.displayName || "Utilisateur DevConnect", avatar_url: user.photoURL ?? undefined, bio: role === "developer" ? "Développeur sur DevConnect" : "Client sur DevConnect", country: "À compléter", skills: [], availability: "available" });
