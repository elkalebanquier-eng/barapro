...
function Router() {
  return <Switch><Route path="/" component={() => <AppLayout><Home /></AppLayout>} /><Route path="/trouver-un-developpeur" component={() => <AppLayout><FindDeveloperPage /></AppLayout>} /><Route path="/explorer" component={() => <AppLayout><FindDeveloperPage /></AppLayout>} /><Route path="/projets" component={() => <AppLayout><ExploreProjectsPage /></AppLayout>} /><Route path="/publier" component={PublishPage} /><Route path="/projet/:slug" component={() => <AppLayout><ProjectDetailPage /></AppLayout>} /><Route path="/profil/:slug" component={() => <AppLayout><DeveloperProfilePage /></AppLayout>} /><Route path="/devenir-developpeur" component={() => <AppLayout><BecomeDeveloperPage /></AppLayout>} /><Route path="/dashboard-client" component={() => <AppLayout><ClientDashboardPage /></AppLayout>} /><Route path="/dashboard-developpeur" component={() => <AppLayout><DeveloperDashboardPage /></AppLayout>} /><Route path="/dashboard" component={DashboardPage} /><Route path="/aide" component={() => <AppLayout><HelpSecurityPage /></AppLayout>} /><Route path="/connexion" component={() => <AppLayout><AuthPage /></AppLayout>} /><Route path="/admin" component={() => <SimplePage title="Espace administration" description="Cette zone est réservée aux comptes administrateurs vérifiés. L'accès sera contrôlé par des règles Firebase, jamais par l'URL seule." icon={ShieldCheck} />} /><Route path="/messages" component={() => <SimplePage title="Messagerie" description="Retrouvez ici vos échanges avec les clients et freelances une fois Firebase connecté." icon={MessageCircle} />} /><Route path="/404" component={NotFound} /><Route component={NotFound} /></Switch>;
}
